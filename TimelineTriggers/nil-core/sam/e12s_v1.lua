local tbl = 
{
	...
	[21] = 
	{
		
		{
			...
			timerStartOffset = -2,
			used = false,
			uuid = "c94a0e9d-fe48-80d2-b33a-2670772b967b",
		},
	...
	[53] = 
	{
		
		{
			...
			enabled = true,
			execute = "-- depending on number this might not go off\nNilsReactionCore.Hotbar.Samurai.ThirdEye()\nself.used = true",
			executeType = 2,
			lastUse = 0,
			loop = false,
			luaNeedsWeaveWindow = false,
