local tbl = 
{
	...
	[32] = 
	{
		...
		
		{
			...
			enabled = true,
			execute = "if NilsReactionCore.Toggles.Dancer.TechnicalStep(NilsReactionCore.params.off, NilsReactionCore.params.isTimeline) == true then self.used = true end",
			executeType = 2,
			lastUse = 0,
			loop = false,
			luaNeedsWeaveWindow = false,
			...
			timerStartOffset = -4,
			used = false,
			uuid = "4c2b166b-486c-6f52-9020-178fe68bbb8f",
		},
	},
	[33] = 
	{
	...
	[39] = 
	{
		...
		
		{
			...
			enabled = true,
			execute = "if NilsReactionCore.Toggles.Dancer.TechnicalStep(NilsReactionCore.params.on, NilsReactionCore.params.isTimeline) == true then self.used = true end",
			executeType = 2,
			lastUse = 0,
			loop = false,
			luaNeedsWeaveWindow = false,
			...
			timerStartOffset = -4,
			used = false,
			uuid = "dae1f0ea-6dd9-b767-94a3-af1b7a799b11",
		},
	},
	[42] = 
	{
